...
SWIFT_SOURCES=(
    ...
    "$SOURCES_DIR/Features/Keyboard/Models/MacroItem.swift"
    "$SOURCES_DIR/Features/Keyboard/Engine/MacroEngine.swift"
    "$SOURCES_DIR/Shared/Services/AppFocusObserver.swift"
    "$SOURCES_DIR/Shared/Services/LaunchAtLoginService.swift"
    "$SOURCES_DIR/Shared/Localization/AppLanguage.swift"
    "$SOURCES_DIR/Shared/Localization/LocalizationService.swift"
    "$SOURCES_DIR/Shared/Settings/SettingsModule.swift"
    "$SOURCES_DIR/Shared/Settings/SettingsStorage.swift"
    "$SOURCES_DIR/Shared/Settings/Modules/KeyboardSettings.swift"
    "$SOURCES_DIR/Shared/Settings/Modules/ClipboardSettings.swift"
    "$SOURCES_DIR/Shared/Settings/Modules/MacroSettings.swift"
